...
/**
 * DTO for GUI-9: Mail ballot rejection data by region
 * Used to display table of mail ballot rejections by reason per EAVS geographic unit
 */
public class MailBallotRejectionByRegionDto {
	...
	public MailBallotRejectionByRegionDto() {
	}

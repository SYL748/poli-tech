...
/**
 * Entity for mail ballot rejection data by region
 * Maps to mail_ballot_rejection_by_region table
 */
@Entity
@Table(name = "mail_ballot_rejection_by_region")
public class MailBallotRejectionByRegionEntity {
	...
	public MailBallotRejectionByRegionEntity() {
	}
